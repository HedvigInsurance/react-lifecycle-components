...
test("should call `was` function when `watched` has changed", () => {
  ...
  const wrapper = mount(
    <Update<UpdateTestWatched>
      watched={{ test: "123", anotherValue: 333 }}
      was={mockWas}
    >
      <div />
    </Update>
...
test("should not call `was` function when `watched` hasn't changed", () => {
  ...
  const wrapper = mount(
    <Update<UpdateTestWatched>
      watched={{ test: "123", anotherValue: 123 }}
      was={mockWas}
    >
      <div />
    </Update>
...
test("should get correct `watched` value on change", () => {
  const was = (
    prevWatched: UpdateTestWatched,
    nextWatched: UpdateTestWatched
  ) => {
  ...
  wrapper.setProps({
    watched: { test: "1234", anotherValue: 12345, somethingElse: 123456 }
  });
});
